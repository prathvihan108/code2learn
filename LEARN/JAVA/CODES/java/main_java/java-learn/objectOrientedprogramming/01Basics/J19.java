 ...
 */
  ...
  * Access to Outer Class Members:
    ...
    A static inner class can access static members of the outer class directly. 
    If the outer class has non-static members, they can be accessed only through an instance of the outer class.

Instance Creation:

    Instances of a static inner class can be created without having an instance of the outer class.
  */
